...
const ImageTemplate = require('./ImageTemplate.cjs');
const Logger =        require('./console/Logger.cjs');
...
[
    ...
    new ImageTemplate('public/entity/editor',                              'MW_Lyt_P_RailU_00',                  'Track',                              'tiff',),
