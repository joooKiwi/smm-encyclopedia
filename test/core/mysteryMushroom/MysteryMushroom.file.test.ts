import file from 'src/resources/compiled/Mystery Mushroom (SMM).json' with {type: 'json',}

import type {Array, NullOr}     from '@joookiwi/type'
import {describe, expect, test} from 'vitest'

import type {AdditionalSoundOnDeath, AdditionalSoundOnGoalPole, PossibleAmountOfSoundEffectOnJump, SoundEffectOnMovement, SpecialMusicInStarMode, TypeOfSoundOnDeath, TypeOfSoundOnGoalPole} from 'src/core/mysteryMushroom/MysteryMushroom.types'
import type {PossibleExcludedLanguages}                                                                                                                                                      from 'test/helperMethods.types'

import {NOT_APPLICABLE, UNKNOWN_REFERENCE}          from 'src/util/commonVariables'
