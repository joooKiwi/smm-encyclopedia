...
import {ArrayAsCollectionHolder, GenericCollectionHolder} from '@joookiwi/collection'

import type {CanSurviveInTheLavaOrThePoison, PossibleLightSource, PossibleWeight}                                                                                                                                                                from 'src/core/entityTypes'
import type {PossibleAcronym as PossibleAcronym_EntityBehaviour, PossibleTranslationKeys as PossibleTranslationKey_EntityBehaviour}                                                                                                              from 'src/core/behaviour/EntityBehaviours.types'
import type {PossibleEnglishName as PossibleEnglishName_CharacterName, PossibleUniqueEnglishName as PossibleUniqueEnglishName_CharacterName}                                                                                                     from 'src/core/characterName/CharacterNames.types'
import type {PossibleEnglishName as PossibleEnglishName_CourseTag, PossibleMakerCentralName}                                                                                                                                                     from 'src/core/courseTag/CourseTags.types'
import type {PossibleEnglishName as PossibleEnglishName_Entity}                                                                                                                                                                                  from 'src/core/entity/Entities.types'
import type {LimitAmountType, PossibleGeneralGlobalLimitComment, PossibleGeneralLimitComment, PossibleOtherLimitComment, PossibleProjectileLimitComment, PossibleRenderedObjectLimitTypeComment}                                                 from 'src/core/entity/properties/limit/loader.types'
import type {PossibleEnglishName as PossibleEnglishName_EntityCategory}                                                                                                                                                                          from 'src/core/entityCategory/EntityCategories.types'
import type {PossibleAcronym as PossibleAcronym_GameReference, PossibleEnglishName as PossibleEnglishName_GameReference}                                                                                                                         from 'src/core/gameReference/GameReferences.types'
import type {PossibleAcronym as PossibleAcronym_GameStyle}                                                                                                                                                                                       from 'src/core/gameStyle/GameStyles.types'
import type {PossibleEnglishName as PossibleEnglishName_Instrument}                                                                                                                                                                              from 'src/core/instrument/Instruments.types'
import type {PossibleMixedInstrument as PossibleMixedName_Instrument}                                                                                                                                                                            from 'src/core/instrument/loader.types'
import type {PossibleEnglishName as PossibleEnglishName_LimitType}                                                                                                                                                                               from 'src/core/limit/LimitTypes.types'
import type {PossibleAcronym as PossibleAcronym_Limit, PossibleAlternativeAcronym as PossibleAlternativeAcronym_Limit, PossibleAlternativeEnglishName as PossibleAlternativeEnglishName_Limit, PossibleEnglishName as PossibleEnglishName_Limit} from 'src/core/limit/Limits.types'
import type {PossibleLimitAmount_Comment, PossibleLimitAmount_SMM1And3DS_Amount, PossibleLimitAmount_SMM2_Amount, PossibleLimitDescription as PossibleLimitDescription_Limit}                                                                    from 'src/core/limit/loader.types'
import type {PossibleEnglishName as PossibleEnglishName_Medal}                                                                                                                                                                                   from 'src/core/medal/Medals.types'
import type {PossibleEnglishName as PossibleEnglishName_MiiCostume}                                                                                                                                                                              from 'src/core/miiCostume/MiiCostumes.types'
import type {PossibleEnglishName as PossibleEnglishName_MiiCostumeCategory}                                                                                                                                                                      from 'src/core/miiCostumeCategory/MiiCostumeCategories.types'
import type {PossibleUniqueEnglishName as UniqueEnglishName_MysteryMushroom}                                                                                                                                                                     from 'src/core/mysteryMushroom/MysteryMushrooms.types'
import type {PokemonGeneration, PossibleConditionToUnlockIt as PossibleConditionToUnlockIt_MysteryMushroom}                                                                                                                                      from 'src/core/mysteryMushroom/loader.types'
import type {TranslationKeyOnDeath as PossibleTranslationKey_SoundEffectOnDeath_MysteryMushroom, TranslationKeyOnGoalPole as PossibleTranslationKey_SoundEffectOnGoalPole_MysteryMushroom}                                                       from 'src/core/mysteryMushroom/MysteryMushroom.types'
import type {PossibleEnglishName as PossibleEnglishName_Theme_NightEffect}                                                                                                                                                                       from 'src/core/nightEffect/NightEffects.types'
import type {PossibleReleaseDate as PossibleReleaseDate_OfficialCourse, PossibleRemovalDate as PossibleRemovalDate_OfficialCourse, PossibleReward as PossibleReward_OfficialCourse}                                                              from 'src/core/officialCourse/loader.types'
import type {PossibleEnglishName as PossibleEnglishName_OfficialCourse}                                                                                                                                                                          from 'src/core/officialCourse/OfficialCourses.types'
import type {PossibleEnglishName as PossibleEnglishName_OfficialNotification, PossibleEnglishNameWithEveryAmount as PossibleEnglishName_OfficialNotificationWithEveryAmount}                                                                     from 'src/core/officialNotification/OfficialNotifications.types'
import type {PossibleEnglishName as PossibleEnglishName_OtherWordInTheGame, PossibleEnglishName_Plural as PossiblePluralEnglishName_OtherWordInTheGame, PossibleEnglishName_Singular as PossibleSingularEnglishName_OtherWordInTheGame}          from 'src/core/otherWordInTheGame/OtherWordInTheGames.types'
import type {PossibleEnglishName as PossibleEnglishName_PredefinedMessage}                                                                                                                                                                       from 'src/core/predefinedMessage/PredefinedMessages.types'
import type {PossibleWorldNumber as PossibleWorldNumber_SampleCourse}                                                                                                                                                                            from 'src/core/sampleCourse/loader.types'
import type {PossibleEnglishName as PossibleEnglishName_SoundEffect}                                                                                                                                                                             from 'src/core/soundEffect/SoundEffects.types'
import type {PossibleEnglishName as PossibleEnglishName_SoundEffectCategory}                                                                                                                                                                     from 'src/core/soundEffectCategory/SoundEffectCategories.types'
import type {PossibleEnglishName as PossibleEnglishName_Theme}                                                                                                                                                                                   from 'src/core/theme/Themes.types'
import type {PossibleName as PossibleName_Version, PossibleName_SMM1 as PossibleName_Version_SMM, PossibleName_SMM2 as PossibleName_Version_SMM2, PossibleName_SMM3DS as PossibleName_Version_SMM3DS}                                            from 'src/core/version/Versions.types'

import {EntityBehaviours}      from 'src/core/behaviour/EntityBehaviours'
import {CharacterNames}        from 'src/core/characterName/CharacterNames'
import {Entities}              from 'src/core/entity/Entities'
import {EntityCategories}      from 'src/core/entityCategory/EntityCategories'
import {Games}                 from 'src/core/game/Games'
import {GameStyles}            from 'src/core/gameStyle/GameStyles'
import {GameReferences}        from 'src/core/gameReference/GameReferences'
import {Instruments}           from 'src/core/instrument/Instruments'
import {LimitTypes}            from 'src/core/limit/LimitTypes'
import {Limits}                from 'src/core/limit/Limits'
import {Medals}                from 'src/core/medal/Medals'
import {NightEffects}          from 'src/core/nightEffect/NightEffects'
import {MiiCostumeCategories}  from 'src/core/miiCostumeCategory/MiiCostumeCategories'
import {MiiCostumes}           from 'src/core/miiCostume/MiiCostumes'
import {MysteryMushrooms}      from 'src/core/mysteryMushroom/MysteryMushrooms'
import {OfficialCourses}       from 'src/core/officialCourse/OfficialCourses'
import {OfficialNotifications} from 'src/core/officialNotification/OfficialNotifications'
import {OtherWordInTheGames}   from 'src/core/otherWordInTheGame/OtherWordInTheGames'
import {PredefinedMessages}    from 'src/core/predefinedMessage/PredefinedMessages'
import {SampleCourses}         from 'src/core/sampleCourse/SampleCourses'
import {SoundEffects}          from 'src/core/soundEffect/SoundEffects'
import {SoundEffectCategories} from 'src/core/soundEffectCategory/SoundEffectCategories'
import {Themes}                from 'src/core/theme/Themes'
import {Versions}              from 'src/core/version/Versions'
import {CourseTags}            from 'src/core/courseTag/CourseTags'
import {INFINITY}              from 'src/util/commonVariables'
...
export class EveryTypes {
    ...
    public get everyPossibleName_theme() {
        return this.#everyPossibleName_theme ??= new ArrayAsCollectionHolder(ALL_THEMES,).map(it => it.englishName,).toArray()
    }

    public get everyPossibleName_courseTheme_smm1() {
        return this.#everyPossibleName_courseTheme_smm1 ??= new ArrayAsCollectionHolder(COURSE_THEMES_SMM1,).map(it => it.englishName,).toArray()
    }
    ...
    public get everyPossibleName_editorLimit() {
        return this.#everyPossibleName_editorLimit ??= new ArrayAsCollectionHolder(Limits.EDITOR,).map(it => it.englishName,).toArray()
    }

    public get everyPossibleName_playLimit() {
        return this.#everyPossibleName_playLimit ??= new ArrayAsCollectionHolder(Limits.PLAY,).map(it => it.englishName,).toArray()
    }
    ...
    public get everyPossibleName_limitType() {
        return this.#everyPossibleName_limitType ??= LimitTypes.Companion.values.map(it => it.englishName,).toArray()
    }
    ...
    public get everyPossibleName_otherWordInTheGame() {
        return this.#everyPossibleName_otherWordInTheGame ??= new ArrayAsCollectionHolder(OtherWordInTheGames.CompanionEnum.get.values.map(it => [it.singularEnglishName, it.pluralEnglishName,],).toArray().flat(),).filterNotNull().toArray()
    }
