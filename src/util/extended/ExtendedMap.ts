...
import type {ClassThatCanGetItemsOrKeys, DefaultValueIfNotFound} from 'util/extended/ClassThatCanGetItems'
import type {ClassThatCanRemoveItems}                            from 'util/extended/ClassThatCanRemoveItems'
import type {ClassThatCanSearchItemsOrKeys, VariableReturnValue} from 'util/extended/ClassThatCanSearchItems'
