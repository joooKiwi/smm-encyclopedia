import {EnumByName as OriginalEnumByName, EnumByNumber as OriginalEnumByNumber, EnumByOrdinal as OriginalEnumByOrdinal, EnumByPossibleString as OriginalEnumByPossibleString, EnumByString as OriginalEnumByString, SimpleEnum as OriginalSimpleEnum} from '../enum/Enum.types';
import {RepeatableTypes as RealEnum}                                                                                                                                                                                                                  from './RepeatableTypes';

export type PossibleNonNullableValue = | RealEnum | Ordinals | PossibleStringValue;
export type PossibleStringValue = |Names|PossibleRepeatableName;
...
export type EnumArray<E extends RealEnum = RealEnum, > = readonly [
    EnumByName<'NONE', E>,
    EnumByName<'AT_THE_END', E>,
    EnumByName<'DURING_THE_PLAY', E>,
];
