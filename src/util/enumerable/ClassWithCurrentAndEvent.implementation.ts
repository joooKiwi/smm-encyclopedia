import type {BasicEnumerableConstructor, Enumerable, PossibleValueByEnumerable} from '@joookiwi/enumerable/dist/types'
 ...
 * as well as the {@link BasicEnumerableConstructor} to call the static methods
 */
export class ClassWithCurrentAndEventImplementation<T extends Enumerable, >
    ...
    public constructor(constructorValue: BasicEnumerableConstructor<T['ordinal'], T['name'], T>,) {
    ...
    public set current(value: PossibleValueByEnumerable<T>,) {
        const selectedValue = this.#constructorValue.getValue<T>(value)
