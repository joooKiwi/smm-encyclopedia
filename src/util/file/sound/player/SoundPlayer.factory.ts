import type {NullableBoolean} from '@joookiwi/type'
...
export class SoundPlayerFactory {
     ...
     */
    public static createSimple<const SOURCE extends SoundFile = SoundFile, const TITLE extends string = string, const DOES_LOOP extends boolean = false, >(source: SOURCE, title: TITLE, doesLoop?: NullableBoolean<DOES_LOOP>,) {
