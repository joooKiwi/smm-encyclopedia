...
import {ExclusiveSMM2GamePropertyInSM3DW} from '../properties/ExclusiveSMM2GamePropertyInSM3DW';
import {ExclusiveSMM2GameStylePropertyInSM3DW} from '../properties/ExclusiveSMM2GameStylePropertyInSM3DW';
import {ExclusiveSMM2TimePropertyInSM3DW}      from '../properties/ExclusiveSMM2TimePropertyInSM3DW';
import {ExclusiveSMM2ThemeProperty}            from '../properties/ExclusiveSMM2ThemeProperty';

export interface ExclusiveSM3DWEntity
    extends ExclusiveSMM2Entity, ExclusiveSMM2PropertyInSM3DW, ExclusiveSMM2GamePropertyInSM3DW, ExclusiveSMM2GameStylePropertyInSM3DW, ExclusiveSMM2TimePropertyInSM3DW {
