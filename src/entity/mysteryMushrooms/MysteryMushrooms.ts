...
export class MysteryMushrooms
    ...
    public static getValue(name: | UniqueEnglishName | EnglishNameOnFile | Names,): MysteryMushrooms
    ...
    public static getValue(value: | MysteryMushrooms | string | number | null | undefined,): | MysteryMushrooms | null
    public static getValue(value: | MysteryMushrooms | string | number | null | undefined,): | MysteryMushrooms | null {
        return value == null
            ? null
            : typeof value === 'string'
