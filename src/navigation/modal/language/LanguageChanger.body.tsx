...
import LanguageChangerLink         from 'navigation/modal/language/LanguageChanger.link'
...
export default function LanguageChangerBody() {
    ...
    return <div id="languageChanger-body" className="container d-flex flex-wrap justify-content-around">{
        ProjectLanguages.CompanionEnum.get.values.map(language => {
