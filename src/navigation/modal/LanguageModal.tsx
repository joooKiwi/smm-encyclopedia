            ...
            <div className="modal-dialog modal-dialog-centered modal-xl">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div id="languageChanger-body" className="container d-flex flex-wrap justify-content-around">
                            <div id="double-languageChanger-english" className="languageChanger-link-container btn-group btn-group-lg col-12 col-xl-5 m-2" role="group">
                            ...
                            <div id="double-languageChanger-french" className="languageChanger-link-container btn-group btn-group-lg col-12 col-xl-5 m-2" role="group">
                            ...
                            <div id="single-languageChanger-german" className="languageChanger-link-container col-12 col-xl-5 m-2">
                                <LanguageChangerSingleLink language={ProjectLanguages.GERMAN} callbackToSetLanguage={callbackToSetLanguage}/>
                            </div>
                            <div id="double-languageChanger-spanish" className="languageChanger-link-container btn-group btn-group-lg col-12 col-xl-5 m-2" role="group">
                            ...
                            <div id="single-languageChanger-italian" className="languageChanger-link-container col-12 col-xl-5 m-2">
                                <LanguageChangerSingleLink language={ProjectLanguages.ITALIAN} callbackToSetLanguage={callbackToSetLanguage}/>
                            </div>
                            <div id="single-languageChanger-dutch" className="languageChanger-link-container col-12 col-xl-5 m-2">
                                <LanguageChangerSingleLink language={ProjectLanguages.DUTCH} callbackToSetLanguage={callbackToSetLanguage}/>
                            </div>
                            <div id="double-languageChanger-portuguese" className="languageChanger-link-container btn-group btn-group-lg col-12 col-xl-5 m-2" role="group">
                            ...
                            <div id="single-languageChanger-russian" className="languageChanger-link-container col-12 col-xl-5 m-2">
                                <LanguageChangerSingleLink language={ProjectLanguages.RUSSIAN} callbackToSetLanguage={callbackToSetLanguage}/>
                            </div>
                            <div id="single-languageChanger-japanese" className="languageChanger-link-container col-12 col-xl-5 m-2">
                                <LanguageChangerSingleLink language={ProjectLanguages.JAPANESE} callbackToSetLanguage={callbackToSetLanguage}/>
                            </div>
                            <div id="double-languageChanger-chinese" className="languageChanger-link-container btn-group btn-group-lg col-12 col-xl-5 m-2" role="group">
                            ...
                            <div id="single-languageChanger-korean" className="languageChanger-link-container col-12 col-xl-5 m-2">
