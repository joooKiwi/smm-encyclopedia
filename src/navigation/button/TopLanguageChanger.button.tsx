...
export default function TopLanguageChangerButton() {
    return <Tooltip elementId={ID} option={({title: contentTranslation('Change the language'), placement: 'left',})}>
        <ModalButton key={`navigation button (top language changer)`} id={ID} elementToShow={LANGUAGE_CHANGER_MODAL_ID} className="btn btn-outline-primary btn-navigation bi bi-translate">
