...
export default function ParameterToLanguageButton() {
    ...
    return <Tooltip option={{title: contentTranslation('Change the language',), placement: 'right',}} reference={htmlElement}>
        <ModalButton ref={htmlElement} id="parameter-to-languageChanger-button" className="btn btn-outline-primary rounded-pill" elementToShow={LANGUAGE_CHANGER_MODAL_ID} elementToHide={PARAMETER_MODAL_ID}>
            <TranslateIcon/>
        </ModalButton>
    </Tooltip>
}
