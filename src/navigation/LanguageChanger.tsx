...
export default function LanguageChanger() {
    return <li key={'languageChanger'} className="nav-item dropdown d-flex">
        ...
        <ul className="dropdown-menu" aria-labelledby="languageChanger">
            ...
            <li><Link key="languageChanger_sp" className="dropdown-item" to="/es">{__('Spanish')}</Link></li>
            <li><Link key="languageChanger_jp" className="dropdown-item" to="/ja">{__('Japanese')}</Link></li>
            <li><Link key="languageChanger_ko" className="dropdown-item" to="/ko">{__('Korean')}</Link></li>
            <li><Link key="languageChanger_chT" className="dropdown-item" to="/zh_T">{__('Chinese (traditional)')}</Link></li>
            <li><Link key="languageChanger_chS" className="dropdown-item" to="/zh_S">{__('Chinese (simplified)')}</Link></li>
        </ul>
    </li>
}