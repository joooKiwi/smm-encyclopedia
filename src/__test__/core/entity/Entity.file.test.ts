...
import type {GeneralEntityLimitType, GeneralGlobalEntityLimitType, LimitAmountType, OffscreenSpawningAndDespawningReferencePoint, OtherLimitCommentType, ProjectileEntityLimitType, RenderedObjectLimitType}                                                                                                                                                                                                                                               from 'core/entity/properties/limit/loader.types'
...
describe('Entity (file test)', () => {
    ...
    const everyGEL = [null, true, false, ...types.everyPossibleGEL_entity,]                                                                                              as const satisfies readonly GeneralEntityLimitType[]
    const everyGELGlobal = [null, true, false, ...types.everyPossibleGELGlobal_entity,]                                                                                  as const satisfies readonly GeneralGlobalEntityLimitType[]
    const everyPJL = [null, true, false, ...types.everyPossiblePJL_entity,]                                                                                              as const satisfies readonly ProjectileEntityLimitType[]
