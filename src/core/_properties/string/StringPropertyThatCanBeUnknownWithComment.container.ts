...
export class StringPropertyThatCanBeUnknownWithCommentContainer<const S extends NullOrString = NullOrString, const IS_UNKNOWN extends boolean = boolean, const COMMENT extends NullOrString = NullOrString, >
