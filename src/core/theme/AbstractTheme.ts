...
export class AbstractTheme<const SMM1_AND_SMM3DS extends boolean = boolean,
    const AVAILABLE_FROM_START_SMM1 extends NullOrBoolean = NullOrBoolean,
    const AVAILABLE_FROM_START_SMM3DS extends NullOrTrue = NullOrTrue, >
