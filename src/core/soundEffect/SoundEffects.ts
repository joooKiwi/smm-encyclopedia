...
import type {PossibleEditorValue}                                                                                                                                                                                                                                                                                                     from './sound/SoundEffectSound';
...
import {SMM2SoundEffectSoundFromBackgroundMusicBuilder} from './sound/SMM2SoundEffectSoundFromBackgroundMusic.builder';
...
export abstract class SoundEffects
    ...
    public static readonly NINJA_ATTACK =           new class SoundEffects_NinjaAttack extends SoundEffects {
        ...
        protected override _createSMM2Sounds() {
            return new SMM2SoundEffectSoundFromBackgroundMusicBuilder('BGM_Otoasobi_Dtbt_MurasameIcon', 'BGM_Otoasobi_Dtbt_Murasame',);
        }
    ...
    public static readonly AUDIENCE =               new class SoundEffects_Audience extends SoundEffects {
        ...
        protected override _createSMM2Sounds() {
            return new SMM2SoundEffectSoundFromBackgroundMusicBuilder('se_otoasobi_clowd',);
        }
    ...
    public static readonly SCATTING =               new class SoundEffects_Scatting extends SoundEffects {
        ...
        protected override _createSMM2Sounds() {
            return new SMM2SoundEffectSoundFromBackgroundMusicBuilder('otoasobi_scat',);
        }
    ...
    public static readonly TRADITIONAL =            new class SoundEffects_Traditional extends SoundEffects {
        ...
        protected override _createSMM2Sounds() {
            return new SMM2SoundEffectSoundFromBackgroundMusicBuilder('se_otoasobi_ohayashi',);
        }
    ...
    public static readonly FINAL_BOSS =             new class SoundEffects_FinalBoss extends SoundEffects {

    }('Final Boss', new SMM2SoundEffectImage('LastBoss',),);
    public static readonly SUPER_MARIO_KART =       new class SoundEffects_SuperMarioKart extends SoundEffects {

    }('Super Mario Kart', new SMM2SoundEffectImage('Mario02',),);
    public static readonly SUPER_MARIO_64 =         new class SoundEffects_SuperMario64 extends SoundEffects {

    }('Super Mario 64', new SMM2SoundEffectImage('Mario01',),);
    public static readonly SUPER_MARIO_SUNSHINE =   new class SoundEffects_SuperMarioSunshine extends SoundEffects {

    }('Super Mario Sunshine', new SMM2SoundEffectImage('Mario02',),);
    public static readonly SUPER_MARIO_GALAXY =     new class SoundEffects_SuperMarioGalaxy extends SoundEffects {
    ...
    #sounds_smm2?: SMM2SoundEffectSound;
    ...
    public get soundsContainer_standaloneSMM1(): SMM1StandaloneSoundEffectSound {
        if (this.#sounds_standaloneSmm1 == null) {
            ...
            const valueToCreate = this._createStandaloneSMM1Sounds(smm1, this.soundsContainer_smm2,);
    ...
    protected _createSMM2Sounds(): | Builder<SMM2SoundEffectSound> | null{
        return null;
    }

    /** The "sound effect" sounds (in a container) of the {@link Games.SUPER_MARIO_MAKER_2 SMM2} game */
    public get soundsContainer_smm2(): SMM2SoundEffectSound {
        return this.#sounds_smm2 ??= this._createSMM2Sounds()?.build() ?? EmptySMMSoundEffectSound.get;
    }

    /** Every "sound effect" sounds stored in a {@link SMM2SoundEffectSound SMM2 "sound effect" sound} */
    public get sounds_smm2(): readonly PossibleSoundEffectSoundFileName_SMM2[] {
    ...
    public get editorSound_smm2(): PossibleEditorValue<readonly PossibleSoundEffectSoundFileName_SMM2[]> {
