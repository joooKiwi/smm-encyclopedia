...
export class SMM1ExclusiveSoundEffectSoundContainer<const out SOUNDS extends readonly SMM1SoundEffectSoundFile[],
    const out EDITOR_SOUNDS extends PossibleEditorValue_SMM1<SOUNDS>, >
