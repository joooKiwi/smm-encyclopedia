...
import {GenericCollectionHolder, mapByArray}     from '@joookiwi/collection'
...
export abstract class InGameBigMushroomEntityImages
    ...
    private static readonly ExistantIn1Folder = class ExistantIn1Folder_InGameBigMushroomEntityImages<const NAME extends PossibleEnglishName,
        ...
        protected override _createImageFiles(fileNames: Array<FILE_NAME>,) {
            ...
            return mapByArray(fileNames, it => bigMushroomImage(this, folderName, it,),)
        }
    ...
    private static readonly ExistantIn2Folder = class ExistantIn2Folder_InGameBigMushroomEntityImages<const NAME extends PossibleEnglishName,
        ...
        protected override _createImageFiles(fileNames: Array<FILE_NAME>,) {
            ...
            return new GenericCollectionHolder(join<InGameSmm1ImageFile_BigMushroom<`${FOLDER_NAME}${| EmptyString | ' D'}`, FILE_NAME, NAME>>(
                mapByArray(fileNames, it => bigMushroomImage(this, folderName, it,),),
                mapByArray(fileNames, it => bigMushroomImage(this, folderNameAlt, it,),),
            ),)
        }
    ...
    public static readonly BUZZY_BEETLE =                                  new InGameBigMushroomEntityImages.ExistantIn2Folder('Buzzy Beetle', 'Met', 'fly.0', 'fly.1', 'shell.0', 'shell.1', 'shell.2', 'shell.3', 'walk.0', 'walk.1',)
    public static readonly PARA_BEETLE =                                   new InGameBigMushroomEntityImages.ExistantIn2Folder('Buzzy Shell', 'Met', 'shellkara.0', 'shellkara.1', 'shellkara.2', 'shellkara.3',)
    public static readonly BUZZY_SHELL =                                   new InGameBigMushroomEntityImages.Null()

    public static readonly SPINY =                                         new InGameBigMushroomEntityImages.ExistantIn1Folder('Spiny', 'Togezo', 'fly.0', 'fly.1', 'shell.0', 'shell.1', 'shell.2', 'shell.3', 'walk.0', 'walk.1',)
    public static readonly WINGED_SPINY =                                  new InGameBigMushroomEntityImages.Null()
    ...
    public static readonly SPIKE_TOP =                                     new InGameBigMushroomEntityImages.ExistantIn1Folder('Spike Top', 'TogemetA', 'fly.0', 'fly.1', 'walk.0', 'walk.1',)
    public static readonly WINGED_SPIKE_TOP =                              new InGameBigMushroomEntityImages.Null()
    public static readonly FAST_SPIKE_TOP =                                new InGameBigMushroomEntityImages.ExistantIn1Folder('Fast Spike Top', 'TogemetB', 'fly.0', 'fly.1', 'walk.0', 'walk.1',)
    public static readonly FAST_WINGED_SPIKE_TOP =                         new InGameBigMushroomEntityImages.Null()
