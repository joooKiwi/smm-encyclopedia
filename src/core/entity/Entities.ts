...
export class Entities
    ...
    public static readonly JELECTRO =                                      new Entities('Jelectro',                                     new EditorImageBuilder('Toge').setTheme(GameStyles.SUPER_MARIO_BROS_3, Themes.UNDERWATER,),);
    public static readonly SEA_URCHIN =                                    new Entities('Sea Urchin',                                   new EditorImageBuilder('Toge').setTheme(GameStyles.SUPER_MARIO_WORLD, Themes.UNDERWATER,),);
