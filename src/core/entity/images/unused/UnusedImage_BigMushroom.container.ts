import type {AngryImages_ClownCar, BlinkingImages_ClownCar, DamagingImages_Goomba, EveryImages_ClownCar, EveryImages_Goomba, EveryImages_Stretch, InBootImages_Goomba, MovingImages_Stretch, SwimmingImages_Goomba, UnusedImage_BigMushroom, WaitImages1_Stretch, WaitImages2_Stretch, WaitingImages_ClownCar, WalkingImages_Goomba, WeepingImages_ClownCar} from './UnusedImage_BigMushroom';
...
export class UnusedImage_BigMushroomContainer
    ...
    public constructor(...images: | ClownCarImagesReceived | GoombaImagesReceived | StretchImagesReceived) {
        const [waitImages_clownCar, angryImages, blinkingImages, weepingImages, damagingImages, swimmingImages, walkingImages, inBootImages, waitImages1_stretch, waitImages2_stretch, movingImages,] = images;
...
type StretchImagesReceived = readonly [
    waitImages_clownCar: null, angryImages: null, blinkingImages: null, weepingImages: null,
    damagingImages: null, swimmingImages: null, walkingImages: null, inBootImages: null,
    waitImages1_stretch: WaitImages1_Stretch, waitImages2_stretch: WaitImages2_Stretch, movingImages: MovingImages_Stretch,
];
