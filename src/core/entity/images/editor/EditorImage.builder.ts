...
import type {ImageNumber, PossibleAmountOfImages, SimpleImageName, VariantEditorImage_PowerUp} from 'core/entity/images/editor/EditorImage.types'
            ...
            case 'string'://ground / snow / power-up
                ...
                switch (defaultType) {
                    ...
                    case 'snow':
                        ...
                        return new Map(this._gameStyles.map(gameStyle => [gameStyle.parent, [this._getImagePath(gameStyle, `_${SNOW.gameName}_0${imageNumber - 1}`,),],]))
                    case 'power-up':
                        if (imageNumber != null)
