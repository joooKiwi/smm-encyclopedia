...
export class UniqueImageBuilder
    ...
    public setOnSMBAnd(...themes: readonly Themes[]): this {
        return this.__setOnGameStyleAnd(GameStyles.SUPER_MARIO_BROS, themes,);
    }

    public setOnSMB3And(...themes: readonly Themes[]): this {
        return this.__setOnGameStyleAnd(GameStyles.SUPER_MARIO_BROS_3, themes,);
    }

    public setOnSMWAnd(...themes: readonly Themes[]): this {
        return this.__setOnGameStyleAnd(GameStyles.SUPER_MARIO_WORLD, themes,);
    }

    public setOnNSMBUAnd(...themes: readonly Themes[]): this {
        return this.__setOnGameStyleAnd(GameStyles.NEW_SUPER_MARIO_BROS_U, themes,);
    }

    public setOnSM3DWAnd(...themes: readonly Themes[]): this {
        return this.__setOnGameStyleAnd(GameStyles.SUPER_MARIO_3D_WORLD, themes,);
    }
    ...
    public setToOnlySMBAnd(...themes: readonly Themes[]): this {
        return this.__setToOnlyGameStyleAnd(GameStyles.SUPER_MARIO_BROS, themes,);
    }

    public setToOnlySMB3And(...themes: readonly Themes[]): this {
        return this.__setToOnlyGameStyleAnd(GameStyles.SUPER_MARIO_BROS_3, themes,);
    }

    public setToOnlySMWAnd(...themes: readonly Themes[]): this {
        return this.__setToOnlyGameStyleAnd(GameStyles.SUPER_MARIO_WORLD, themes,);
    }

    public setToOnlyNSMBUAnd(...themes: readonly Themes[]): this {
        return this.__setToOnlyGameStyleAnd(GameStyles.NEW_SUPER_MARIO_BROS_U, themes,);
    }

    public setToOnlySM3DWAnd(...themes: readonly Themes[]): this {
        return this.__setToOnlyGameStyleAnd(GameStyles.SUPER_MARIO_3D_WORLD, themes,);
    }
    ...
    public setOnSMBAndAllThemes(): this {
        return this.setOnGameStyleAndAllThemes(GameStyles.SUPER_MARIO_BROS,);
    }

    public setOnSMB3AndAllThemes(): this {
        return this.setOnGameStyleAndAllThemes(GameStyles.SUPER_MARIO_BROS_3,);
    }

    public setOnSMWAndAllThemes(): this {
        return this.setOnGameStyleAndAllThemes(GameStyles.SUPER_MARIO_WORLD,);
    }

    public setOnNSMBUAndAllThemes(): this {
        return this.setOnGameStyleAndAllThemes(GameStyles.NEW_SUPER_MARIO_BROS_U,);
    }

    public setOnSM3DWAndAllThemes(): this {
        return this.setOnGameStyleAndAllThemes(GameStyles.SUPER_MARIO_3D_WORLD,);
    }
    ...
    public setToOnlySMBAndAllThemes(): this {
        return this.setToOnlyGameStyleAndAllThemes(GameStyles.SUPER_MARIO_BROS,);
    }

    public setToOnlySMB3AndAllThemes(): this {
        return this.setToOnlyGameStyleAndAllThemes(GameStyles.SUPER_MARIO_BROS_3,);
    }

    public setToOnlySMWAndAllThemes(): this {
        return this.setToOnlyGameStyleAndAllThemes(GameStyles.SUPER_MARIO_WORLD,);
    }

    public setToOnlyNSMBUAndAllThemes(): this {
        return this.setToOnlyGameStyleAndAllThemes(GameStyles.NEW_SUPER_MARIO_BROS_U,);
    }

    public setToOnlySM3DWAndAllThemes(): this {
        return this.setToOnlyGameStyleAndAllThemes(GameStyles.SUPER_MARIO_3D_WORLD,);
    }
    ...
    #createWhilePlayingImageMap(image: InGameImage,): ReadonlyMap<GameStyles, readonly string[]> {
        return new Map(
            this._gameStyles.map(gameStyle => [gameStyle, image.get(false, gameStyle, Themes.GROUND,),] as const)
                .filter(([, images,]) => images.length !== 0)
        );
    }
