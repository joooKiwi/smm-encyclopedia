...
export function all(entity: ClearConditionEntityImages, name: ImageName_ClearCondition,): ClearConditionImage {
    return new ClearConditionImageContainer([
        [GameStyles.SUPER_MARIO_BROS, clearConditionImage(entity, name, GameStyles.SUPER_MARIO_BROS,),],
        [GameStyles.SUPER_MARIO_BROS_3, clearConditionImage(entity, name, GameStyles.SUPER_MARIO_BROS_3,),],
        [GameStyles.SUPER_MARIO_WORLD, clearConditionImage(entity, name, GameStyles.SUPER_MARIO_WORLD,),],
        [GameStyles.NEW_SUPER_MARIO_BROS_U, clearConditionImage(entity, name, GameStyles.NEW_SUPER_MARIO_BROS_U,),],
        [GameStyles.SUPER_MARIO_3D_WORLD, clearConditionImage(entity, name, GameStyles.SUPER_MARIO_3D_WORLD,),],
    ],)
}


export function onlySmb(entity: ClearConditionEntityImages, name: ImageName_ClearCondition,): ClearConditionImage {
    return new ClearConditionImageContainer([[GameStyles.SUPER_MARIO_BROS, clearConditionImage(entity, name, GameStyles.SUPER_MARIO_BROS,),],],)
}
export function onlySmb3(entity: ClearConditionEntityImages, name: ImageName_ClearCondition,): ClearConditionImage {
    return new ClearConditionImageContainer([[GameStyles.SUPER_MARIO_BROS_3, clearConditionImage(entity, name, GameStyles.SUPER_MARIO_BROS_3,),],],)
}
export function onlySmw(entity: ClearConditionEntityImages, name: ImageName_ClearCondition,): ClearConditionImage {
    return new ClearConditionImageContainer([[GameStyles.SUPER_MARIO_WORLD, clearConditionImage(entity, name, GameStyles.SUPER_MARIO_WORLD,),],],)
}
export function onlyNsmbu(entity: ClearConditionEntityImages, name: ImageName_ClearCondition,): ClearConditionImage {
    return new ClearConditionImageContainer([[GameStyles.NEW_SUPER_MARIO_BROS_U, clearConditionImage(entity, name, GameStyles.NEW_SUPER_MARIO_BROS_U,),],],)
}
export function onlySm3dw(entity: ClearConditionEntityImages, name: ImageName_ClearCondition,): ClearConditionImage {
    return new ClearConditionImageContainer([[GameStyles.SUPER_MARIO_3D_WORLD, clearConditionImage(entity, name, GameStyles.SUPER_MARIO_3D_WORLD,),],],)
}
