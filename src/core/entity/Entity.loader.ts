...
interface Content
    ...
    readonly editor_canBePutOnATrack: NullOrString<PossibleEnglishName_Limit>
    readonly whilePlaying_canBePutOnATrack: NullOrString<| PossibleEnglishName_Limit | UnknownCharacter>
...
function createReference(content: Content, referenceLinks: ReferenceLinks, entityCategoryMap: EntityCategoryMap,): Entity {
    ...
    return new EntityContainer(
        ...
        content.canBePutOnATrack, getLimit(content.editor_canBePutOnATrack,), getLimit(content.whilePlaying_canBePutOnATrack,),
...
function getLimit(value: PossibleEnglishName_Limit,): Limits
function getLimit(value: NullableString<PossibleEnglishName_Limit>,): NullOr<Limits>
function getLimit(value: | PossibleEnglishName_Limit | UnknownCharacter,): | Limits | UnknownCharacter
function getLimit(value: NullableString<| PossibleEnglishName_Limit | UnknownCharacter>,): NullOr<| Limits | UnknownCharacter>
function getLimit(value: | PossibleEnglishName_Limit | NotApplicable,): | Limits | NotApplicable
function getLimit(value: NullableString<| PossibleEnglishName_Limit | NotApplicable>,): NullOr<| Limits | NotApplicable>
function getLimit(value: NullableString<| PossibleEnglishName_Limit | NotApplicable | UnknownCharacter>,) {
    if (value == null)
        return null
