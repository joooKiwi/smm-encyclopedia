...
import type {DimensionTemplate, EntityTemplate, SimpleDimensionTemplate}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              from './Entity.template';
import {SimpleDimensionTemplateDifferentInSM3DW}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      from './Entity.template';
    ...
    public load(): ReadonlyMap<PossibleEnglishName, Entity> {
        if (this.#map == null) {
            ...
            new CSVLoader<PropertiesArray, Builder<EntityTemplate>, keyof typeof Headers>(everyEntities, convertedContent => new TemplateBuilder(convertedContent))
                ...
                .convertToBooleanAnd([EntityLoader.UNKNOWN_CHARACTER, 'Green Winged Koopa Troopa', 'winged',], 'canBeSpawnedByWingedMagikoopa',)
