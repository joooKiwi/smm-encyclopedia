...
enum Enum {
    ...
    ANGRY_SUN_MOON_LIMIT, PHANTO_LIMIT, KOOPA_TROOPA_CAR_LIMIT,
...
export type EnumArray<T extends RealEnum = RealEnum, > = readonly [
    ...
    SimpleEnum<T>['ANGRY_SUN_MOON_LIMIT'], SimpleEnum<T>['PHANTO_LIMIT'], SimpleEnum<T>['KOOPA_TROOPA_CAR_LIMIT'],
