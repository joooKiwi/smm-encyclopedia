...
export interface SoundEffectMusicWithDifferentEditor<out SOUND_EFFECT extends MusicSoundFile<PossibleSoundEffectEditorOnly_Name> = MusicSoundFile<PossibleSoundEffectEditorOnly_Name>,
    out EDITOR_SOUND_EFFECT extends MusicSoundFile<PossibleSoundEffectEditorOnly_EditorName> = MusicSoundFile<PossibleSoundEffectEditorOnly_EditorName>, >
