import type {FullMusicPathOn, Music}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   from '../Music';
...
export interface BackgroundMusic<SMB_EDITOR_MUSIC extends PossibleSMB_EditorMusic_GroupContainer = PossibleSMB_EditorMusic_GroupContainer, SMB_MUSIC extends PossibleSMB_RegularMusic_GroupContainer = PossibleSMB_RegularMusic_GroupContainer, SMB_FAST_MUSIC extends PossibleSMB_FastMusic_GroupContainer = PossibleSMB_FastMusic_GroupContainer,
    ...
    extends Music<readonly FullMusicPathOn<Possible_Music>[]> {
...
export type PossibleSMB_EditorMusic_GroupContainer = | PossibleSMB_EditorMusic | PossibleOther_EditorMusic | null;
export type PossibleSMB_RegularMusic_GroupContainer = | PossibleSMB_RegularMusic | PossibleOther_RegularMusic | null;
export type PossibleSMB_FastMusic_GroupContainer = | PossibleSMB_FastMusic | PossibleOther_FastMusic | null;

export type PossibleLink_RegularMusic_GroupContainer = | PossibleLink_RegularMusic | PossibleLink_LinkMusic | null;
export type PossibleLink_FastMusic_GroupContainer = | PossibleLink_FastMusic | PossibleLink_LinkMusic | null;

export type PossibleSMB2_RegularMusic_GroupContainer = | PossibleSMB2_RegularMusic | PossibleSMB2_SMB2Music | null;
export type PossibleSMB2_FastMusic_GroupContainer = | PossibleSMB2_FastMusic | PossibleSMB2_SMB2Music | null;

export type PossibleSMB3_EditorMusic_GroupContainer = | PossibleSMB3_EditorMusic | PossibleOther_EditorMusic | null;
export type PossibleSMB3_RegularMusic_GroupContainer = | PossibleSMB3_RegularMusic | PossibleOther_RegularMusic | null;
export type PossibleSMB3_FastMusic_GroupContainer = | PossibleSMB3_FastMusic | PossibleOther_FastMusic | null;

export type PossibleSMW_EditorMusic_GroupContainer = | PossibleSMW_EditorMusic | PossibleOther_EditorMusic | null;
export type PossibleSMW_RegularMusic_GroupContainer = | PossibleSMW_RegularMusic | PossibleOther_RegularMusic | null;
export type PossibleSMW_RegularYoshiSound_GroupContainer = | PossibleSMW_RegularYoshiSound | null;
export type PossibleSMW_FastMusic_GroupContainer = | PossibleSMW_FastMusic | PossibleOther_FastMusic | null;
export type PossibleSMW_FastYoshiSound_GroupContainer = | PossibleSMW_FastYoshiSound | null;

export type PossibleNSMBU_EditorMusic_GroupContainer = | PossibleNSMBU_EditorMusic | PossibleOther_EditorMusic | null;
export type PossibleNSMBU_RegularMusic_GroupContainer = | PossibleNSMBU_RegularMusic | PossibleOther_RegularMusic | null;
export type PossibleNSMBU_RegularYoshiSound_GroupContainer = | PossibleNSMBU_RegularYoshiSound | null;
export type PossibleNSMBU_FastMusic_GroupContainer = | PossibleNSMBU_FastMusic | PossibleOther_FastMusic | null;
export type PossibleNSMBU_FastYoshiSound_GroupContainer = | PossibleNSMBU_FastYoshiSound | null;

export type PossibleSM3DW_EditorMusic_GroupContainer = | PossibleSM3DW_EditorMusic | PossibleOther_EditorMusic | null;
export type PossibleSM3DW_RegularMusic_GroupContainer = | PossibleSM3DW_RegularMusic | PossibleOther_RegularMusic | null;
export type PossibleSM3DW_UnderwaterMusic_GroupContainer = | PossibleSM3DW_RegularUnderwaterMusic | null;
export type PossibleSM3DW_FastMusic_GroupContainer = | PossibleSM3DW_FastMusic | PossibleOther_FastMusic | null;
export type PossibleSM3DW_FastUnderwaterMusic_GroupContainer = | PossibleSM3DW_FastUnderwaterMusic | null;
