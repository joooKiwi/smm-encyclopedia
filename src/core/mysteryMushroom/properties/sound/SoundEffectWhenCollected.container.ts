import type {PossibleGamesReceived, PossibleValues, PossibleValuesReceived, SoundEffectWhenCollected} from 'core/mysteryMushroom/properties/sound/SoundEffectWhenCollected'
