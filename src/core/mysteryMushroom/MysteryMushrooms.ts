...
import {SingleFileNameContainer as SingleFile} from './file/name/SingleFileName.container';
...
export class MysteryMushrooms
    ...
    public static readonly SONIC =                  new class MysteryMushrooms_Sonic extends MysteryMushrooms {
        ...
        protected override _createImageContainer(file: PossibleFileName,): Image {
