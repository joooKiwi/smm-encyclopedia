...
export class OtherWordInTheGames<const SINGULAR extends PossibleEnglishName_Singular = PossibleEnglishName_Singular,
    const PLURAL extends NullOr<PossibleEnglishName_Plural> = NullOr<PossibleEnglishName_Plural>,
    const IS_A_COMPLETE_WORD extends boolean = boolean, >
    ...
    private static readonly CompleteOtherWordInTheGame = class CompleteOtherWordInTheGame<const SINGULAR extends PossibleEnglishName_Singular = PossibleEnglishName_Singular,
        const PLURAL extends NullOr<PossibleEnglishName_Plural> = null, >
        extends OtherWordInTheGames<SINGULAR, PLURAL, true> {
     ...
     */
    private static readonly CompleteInSMM1OtherWordInTheGame = class CompleteInSMM1OtherWordInTheGame<const SINGULAR extends PossibleEnglishName_Singular = PossibleEnglishName_Singular,
        const PLURAL extends NullOr<PossibleEnglishName_Plural> = null, >
     ...
     */
    private static readonly CompleteInSMM2OtherWordInTheGame = class CompleteInSMM2OtherWordInTheGame<const SINGULAR extends PossibleEnglishName_Singular = PossibleEnglishName_Singular,
        const PLURAL extends NullOr<PossibleEnglishName_Plural> = null, >
        extends OtherWordInTheGames.CompleteOtherWordInTheGame<SINGULAR, PLURAL> {
    ...
    private static readonly UnfinishedOtherWordInTheGame = class UnfinishedOtherWordInTheGame<const SINGULAR extends PossibleEnglishName_Singular = PossibleEnglishName_Singular,
        const PLURAL extends NullOr<PossibleEnglishName_Plural> = null, >
        extends OtherWordInTheGames<SINGULAR, PLURAL, false> {
