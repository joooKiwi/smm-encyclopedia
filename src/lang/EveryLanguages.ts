...
export abstract class EveryLanguages<const ACRONYM extends PossibleAcronym = PossibleAcronym,
    ...
    private static readonly ParentCompleted = (() => {
        abstract class ParentCompletedEveryLanguages<const ACRONYM extends PossibleAcronym = PossibleAcronym,
            ...
            public abstract override original<T, >(classWithEveryLanguages: AnyClassWithEveryLanguages<T>,): | T | ArrayOf2<T>
    ...
    public original<T, >(classWithEveryLanguages: CompleteClassWithEveryLanguages<T>,): | T | ArrayOf2<T>
    public original<T, >(classWithEveryLanguages: ClassWithEveryLanguages<T>,): NullOr<| T | ArrayOf2<T>>
