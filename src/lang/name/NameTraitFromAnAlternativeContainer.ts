 ...
 * but with every method that the trait reference has with "alternativeContainer" before.
 */
export interface NameTraitFromAnAlternativeContainer<out T, out ALTERNATIVE_CONTAINER extends NameTrait<T>, > {
