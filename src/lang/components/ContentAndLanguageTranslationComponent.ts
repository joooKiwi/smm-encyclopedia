...
export default abstract class ContentAndLanguageTranslationComponent<T extends ContentAndLanguageTranslationElement = ContentAndLanguageTranslationElement>
    extends Component<T> {
