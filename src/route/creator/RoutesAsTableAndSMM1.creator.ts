...
export class RoutesAsTableAndSMM1Creator<const PARENT_NAME extends string, const PARENT_PATH extends string, > {
    ...
    public create(renderCallback: RenderCallbackByViewDisplayAndGames,): readonly Route<PARENT_NAME, PossibleTableAndGameRouteName<PARENT_NAME>, PossibleGameRoutePath<PossibleTableRoutePath<PARENT_PATH>>>[] {
        ...
        return [
            ...
            new SimpleRouteByViewDisplayAndGames(name, `${name} (list Game=1)`,        finalListPath,                     ViewDisplays.SIMPLE_LIST, RoutesCreator.SMM1_ONLY_GAMES, renderCallback,),
            new SimpleRedirectRoute(name,              `${name} (list Game=3DS)`,      `/game-3ds/list${path}`,      finalListPath,),
            new SimpleRedirectRoute(name,              `${name} (list Game=2)`,        `/game-2/list${path}`,        finalListPath,),
            ...
            new SimpleRouteByViewDisplayAndGames(name, `${name} (card Game=1)`,        finalCardPath,                     ViewDisplays.CARD_LIST, RoutesCreator.SMM1_ONLY_GAMES, renderCallback,),
            new SimpleRedirectRoute(name,              `${name} (card Game=3DS)`,      `/game-3ds/card${path}`,      finalCardPath,),
            new SimpleRedirectRoute(name,              `${name} (card Game=2)`,        `/game-2/card${path}`,        finalCardPath,),
            ...
            new SimpleRouteByViewDisplayAndGames(name, `${name} (table Game=1)`,       finalTablePath,                    ViewDisplays.TABLE, RoutesCreator.SMM1_ONLY_GAMES, renderCallback,),
            new SimpleRedirectRoute(name,              `${name} (table Game=3DS)`,     `/game-3ds/table${path}`,     finalTablePath,),
            new SimpleRedirectRoute(name,              `${name} (table Game=2)`,       `/game-2/table${path}`,       finalTablePath,),
