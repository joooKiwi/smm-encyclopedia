...
import type {FullGroupUrlName_WithNotSMM2, FullGroupUrlName_WithSMM2} from 'core/game/Games.types'
...
export type PossibleRouteName = | `everyEntity (${PossibleUrlValue} ${FullGroupUrlName_WithSMM2} GameStyle=${| 'all' | PossibleSimpleValue})`
                                | `everyEntity (${PossibleUrlValue} ${FullGroupUrlName_WithNotSMM2} GameStyle=${| 'all' | PossibleSimpleValue_SMM1})`
