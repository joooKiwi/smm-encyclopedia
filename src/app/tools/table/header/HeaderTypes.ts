...
export abstract class HeaderTypes
    ...
    public static readonly CompanionEnum: CompanionEnumSingleton<HeaderTypes, typeof HeaderTypes> = class CompanionEnum_HeaderTypes
        extends CompanionEnum<HeaderTypes, typeof HeaderTypes> {
    ...
    public static [Symbol.iterator](): CollectionIterator<HeaderTypes> {
        return HeaderTypes.CompanionEnum.get[Symbol.iterator]()
    }
