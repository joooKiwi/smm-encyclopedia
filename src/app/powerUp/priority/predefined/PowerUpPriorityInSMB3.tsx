...
export default function PowerUpPriorityInSMB3({children: [superStar, lakituCloud, koopaClownCar, fireKoopaClownCar, buzzyShell, spinyShell, dryBonesShell, shoe, stiletto, superMushroom, fireFlower, superLeaf, frogSuit,], games,}: PropertiesWithGames<SMB3PowerUpPriorities>,) {
    return <GroupOf4PowerUpPriority id="powerUpPriority-group-smb3" isTopArrowSeparated isFirstDiagonalArrowSeparated isSecondDiagonalArrowSeparated isRightArrowSeparated>
        ...
        <SimplePowerUpPriority games={games} gameStyle={SMB3} images={IMAGE_CALLBACK}>{[superMushroom, fireFlower, superLeaf, frogSuit,]}</SimplePowerUpPriority>
        <MountableObjectPriority gameStyle={SMB3} images={IMAGE_CALLBACK}>{[lakituCloud, koopaClownCar, fireKoopaClownCar,]}</MountableObjectPriority>
        <ShellAndShoeMountablePriority games={games} gameStyle={SMB3} images={IMAGE_CALLBACK}>{[buzzyShell, spinyShell, dryBonesShell, shoe, stiletto,]}</ShellAndShoeMountablePriority>
