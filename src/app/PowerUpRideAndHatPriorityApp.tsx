...
export default class PowerUpRideAndHatPriorityApp
    ...
    static readonly #CAR: SM3DWPowerUpPriority =                                    new SMM2PowerUpPriority(CAR,                        SUPER_MARIO_3D_WORLD,   (_, gameStyle,) =>
    ...
    #createLegend(): NonNullable<ReactElement> {
        return <div id="powerUpRideAndHatPriority-legend-container" className="border rounded border-dark border-opacity-25 ms-auto">
            ...
            <div id="powerUpRideAndHatPriority-information-container" className="px-3 d-flex flex-column flex-sm-row flex-lg-column flex-xl-row">
                ...
                <ul className="list-unstyled m-0">
                    <li id="example-withLag" className="d-flex"><div className="color rounded my-auto"/><UnfinishedText>With lag</UnfinishedText></li>
                    <li id="example-withoutLag" className="d-flex"><div className="color rounded my-auto"/><UnfinishedText>Without lag</UnfinishedText></li>
                </ul>
            </div>
        </div>
    }
