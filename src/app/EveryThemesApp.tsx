...
export default class EveryThemesApp
    ...
    protected _mainContent(): JSX.Element {
        ...
        return <Table
            id="theme_table"
            caption={<GameContentTranslationComponent>{translation => translation('Every themes')}</GameContentTranslationComponent>}
            headers={[
                '#',
                {key: 'image', element: <ContentTranslationComponent>{translation => translation('Image')}</ContentTranslationComponent>,},
                {key: 'isInTheCourseTheme', element: <GameContentTranslationComponent>{translation => translation('Is in the course theme')}</GameContentTranslationComponent>,},
                {key: 'isInTheWorldTheme', element: <GameContentTranslationComponent>{translation => translation('Is in the world theme')}</GameContentTranslationComponent>,},
